...
# Exchange client is injected at runtime — no hard dependency on any specific exchange.
# Consumers should pass any object implementing get_klines(symbol, interval, limit).
