...
class MarketCalendar:
    ...
    def __init__(self, year: int = 2026) -> None:
        ...
        self._extra_holidays: dict[Market, set[date]] = {m: set() for m in Market}
    ...
    def next_trading_day(self, d: date, market: str | Market = Market.US) -> date:
    ...
    def previous_trading_day(self, d: date, market: str | Market = Market.US) -> date:
