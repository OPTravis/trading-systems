...
class TestPaperClientLast:
    @pytest.mark.asyncio
    async def test_place_limit_order_buy_below(self):
        """Limit buy below market → stays pending."""
    ...
    @pytest.mark.asyncio
    async def test_place_limit_order_sell_above(self):
        """Limit sell above market → stays pending."""
        from src.brokers.broker_protocol import (
            Contract,
            Order,
            OrderSide,
