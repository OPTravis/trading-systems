...
class TestSmartOrder:
    ...
    # NOTE: calculate_position_size() and related methods were removed from
    # SmartOrder in P2-7 (module overlap elimination). Position sizing is
    # now exclusively handled by KellyPositionSizer in TradeExecutor.
