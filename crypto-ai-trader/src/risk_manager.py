...
All state is persisted to local JSON files in ~/crypto-ai-trader/data/.
"""
    ...
    def pre_trade_check(
        ...
        if positions is not None:
            try:
                ...
                # Use caller-provided account_equity; fallback to computing from
                # positions + Binance USDT balance
