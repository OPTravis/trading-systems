...
class Backtester:
    ...
    def __init__(self, initial_capital: float = 10000, slippage: float = 0.001,
                 fee_rate: float = 0.001, position_size: float = 0.1):
    ...
    def backtest_strategy(
        ...
        results = self._run_backtest(strategy, klines, symbol,
    ...
    def _run_backtest(self, strategy, klines: List[Dict], symbol: str,
                      slippage: float = 0.001, fee_rate: float = 0.001,
    ...
    def optimize_strategy(
        ...
        for combo in itertools.product(*values):
            ...
            result = self.backtest_strategy(strategy_name, symbol, interval, days, params)
            results.append({
                "params": params,
